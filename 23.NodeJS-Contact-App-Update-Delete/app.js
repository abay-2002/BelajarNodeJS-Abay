...
const {cekDuplikat, loadFile, findContact} = require('./utils/contacts');
...
app.get('/contact/delete/:email', (req, res) => {
    const deleteCont = require('./utils/contacts');
    deleteCont.deleteContact(req.params.email);
    res.redirect('/contact');
})
...
app.get('/contact/edit-contact/:nama', (req, res) => {
    ...
    // const load = require('./utils/contacts');
    // const contact = load.findContact(req.params.nama);
    const fetch = require('./utils/contacts');
    const contact = fetch.findContact(req.params.nama);
